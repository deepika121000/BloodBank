...
<body>
    <form action="addtoBank.php" method="post">
    <label> Donor id: </label>  
    <input type = "text" id ="donor_id" name  = "donor_id" />  
    <label> Date : </label>  
    <input type = "date" id ="Date_donated" max="2021-06-01" name  = "Date_donated" /> 
...
$sql = "SELECT Donor_id,donor_name,D_BloodGroup,donor_city,iron_content,ph_no,weight FROM donor where D_approval='YES'";
